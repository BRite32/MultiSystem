...
package com.hsbadr.MultiSystem.helpers.CMDProcessor;
...
public class Shell {
    ...
    public static final String BUILD_PROP = "/MultiSystem/build.prop";
    ...
    public static final String SED_DNS_1 = "busybox sed -i \'/net.dns1=8.8.8.8/d\' /MultiSystem/build.prop";
    public static final String SED_DNS_2 = "busybox sed -i \'/net.dns2=8.8.4.4/d\' /MultiSystem/build.prop";
    public static final String ECHO_DNS_1 = "busybox echo \"net.dns1=8.8.8.8\" >> /MultiSystem/build.prop";
    public static final String ECHO_DNS_2 = "busybox echo \"net.dns2=8.8.4.4\" >> /MultiSystem/build.prop";
    ...
    public static final String SED_STREAMING = "busybox sed -i \'/media.stagefright.enable-/d\' /MultiSystem/build.prop";
    public static final String[] STREAMING_TWEAKS = {
            "busybox echo \"media.stagefright.enable-player=true\" >> /MultiSystem/build.prop",
            "busybox echo \"media.stagefright.enable-meta=true\" >> /MultiSystem/build.prop",
            "busybox echo \"media.stagefright.enable-scan=true\" >> /MultiSystem/build.prop",
            "busybox echo \"media.stagefright.enable-http=false\" >> /MultiSystem/build.prop",
    ...
    public static final String SED_HSUPA = "busybox sed -i \'/ro.ril.hsxpa=/d\' /MultiSystem/build.prop";
    public static final String ECHO_HSUPA = "busybox echo \"ro.ril.hsxpa=3\" >> /MultiSystem/build.prop";
